            ...
            <div className="order-1 lg:order-1 space-y-6 lg:space-y-8">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed animate-fade-in-up animation-delay-200">
                  OphoTech-Specific Case Study: Agile Rollout of a Dealer Self-Service Portal for an Auto Parts Manufacturer
                </p>
              </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative group">
                <div className="glass-effect rounded-3xl overflow-hidden border border-white/20 backdrop-blur-xl shadow-2xl">
                  <img
                    src="https://images.unsplash.com/photo-1590615370581-265ae19a053b?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fEZpeCUyMFF1aWNrbHklMkNJbXByb3ZlQ29udGludW91c2x5fGVufDB8fDB8fHww"
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">decrease in support calls from dealers (manual help requests dropped significantly)</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">30%</div>
                <p className="text-gray-300 text-sm leading-relaxed">improvement in order accuracy due to better user flows</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">90%</div>
                <p className="text-gray-300 text-sm leading-relaxed">dealer adoption rate within 3 months</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">45%</div>
                <p className="text-gray-300 text-sm leading-relaxed">faster warranty claim resolution due to digitized documentation and automated workflows</p>
              </div>
            </div>
          </div>
