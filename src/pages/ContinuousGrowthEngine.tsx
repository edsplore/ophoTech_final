            ...
            <div className="order-1 lg:order-1 space-y-6 lg:space-y-8">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed animate-fade-in-up animation-delay-200">
                  OphoTech-Specific Case Study: Scaling SaaS Efficiency Through Licensed AI Models
                </p>
              </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative group">
                <div className="glass-effect rounded-3xl overflow-hidden border border-white/20 backdrop-blur-xl shadow-2xl">
                  <img
                    src="https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?q=80&w=1674&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Continuous Growth Engine - Geometric Digital Innovation"
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">reduction in product development time</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">40%</div>
                <p className="text-gray-300 text-sm leading-relaxed">faster time-to-market for new features</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">3x</div>
                <p className="text-gray-300 text-sm leading-relaxed">increase in innovation velocity</p>
                <div className="text-xs text-gray-400 mt-1">(measured by feature rollouts per quarter)</div>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">85%</div>
                <p className="text-gray-300 text-sm leading-relaxed">reduction in R&D overhead costs</p>
              </div>
            </div>
          </div>
