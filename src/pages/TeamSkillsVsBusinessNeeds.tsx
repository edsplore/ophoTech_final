            ...
            <div className="order-1 lg:order-1 space-y-6 lg:space-y-8">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed animate-fade-in-up animation-delay-200">
                  OphoTech-Specific Case Study: Bridging the Capability Gap for AI Transformation in a Telecom Enterprise
                </p>
              </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative group">
                <div className="glass-effect rounded-3xl overflow-hidden border border-white/20 backdrop-blur-xl shadow-2xl">
                  <img
                    src="https://images.unsplash.com/photo-1519626504899-7a03a8a9ab51?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">82%</div>
                <p className="text-gray-300 text-sm leading-relaxed">project readiness achieved within 90 days (measured by skill validation tests + real project contributions)</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">3x</div>
                <p className="text-gray-300 text-sm leading-relaxed">faster delivery of first AI-powered dashboard (from 6 months planned to 2 months actual)</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">40%</div>
                <p className="text-gray-300 text-sm leading-relaxed">improvement in cross-functional collaboration between tech and business units</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">18%</div>
                <p className="text-gray-300 text-sm leading-relaxed">retention rate increased among upskilled staff</p>
              </div>
            </div>
          </div>
