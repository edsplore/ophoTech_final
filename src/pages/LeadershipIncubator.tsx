    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-dark via-primary-medium to-primary-950">
            ...
            <div className="order-1 lg:order-1 space-y-6 lg:space-y-8">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed animate-fade-in-up animation-delay-200">
                  OphoTech-Specific Case Study: Building AI-Ready Tech Leaders through Licensed Learning Modules
                </p>
              </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="relative group">
                <div className="glass-effect rounded-3xl overflow-hidden border border-white/20 backdrop-blur-xl shadow-2xl">
                  <img
                    src="https://images.unsplash.com/photo-1739036868260-c26b292cd85d?q=80&w=2232&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Future Leaders Accelerator - AI Innovation"
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">improvement in AI project ownership and solution delivery</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">35%</div>
                <p className="text-gray-300 text-sm leading-relaxed">faster internal mobility for emerging tech leaders</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">80%</div>
                <p className="text-gray-300 text-sm leading-relaxed">engagement rate in self-paced AI learning pathways</p>
              </div>
              
              <div className="glass-effect rounded-xl p-6 backdrop-blur-xl border border-white/20 text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-4xl lg:text-5xl font-bold text-primary-400 mb-2">3</div>
                <p className="text-gray-300 text-sm leading-relaxed">new AI products conceptualized and prototyped within 6 months</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            <div className="glass-effect rounded-2xl p-8 backdrop-blur-xl border border-white/20 text-center max-w-4xl mx-auto">
