...
const Suppliers: React.FC = () => {
  ...
  const handleQuickFormSubmit = (e: React.FormEvent) => {
    ...
    alert('Thank you for your supplier inquiry! We will get back to you within 24 hours.');
  ...
  const handlePartnershipFormSubmit = (e: React.FormEvent) => {
    ...
    alert('Thank you for your supplier partnership inquiry! Our business development team will contact you soon.');
    setPartnershipFormData({ name: '', email: '', company: '', partnershipType: 'service', message: '' });
  };
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Supplier <span className="bg-gradient-to-r from-primary-500 to-accent-cyan bg-clip-text text-transparent">Partnership</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Get in touch with our team for supplier partnerships and service collaboration opportunities. 
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            {/* Supplier Partnership Inquiries */}
            <div className="glass-effect rounded-2xl p-4 sm:p-6 lg:p-8 backdrop-blur-xl border border-white/20">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white">Supplier Partnership Inquiries</h2>
                  <p className="text-sm sm:text-base text-gray-300">Collaboration opportunities for service suppliers.</p>
                </div>
              </div>
              ...
              <form onSubmit={handlePartnershipFormSubmit} className="space-y-4">
                ...
                <textarea
                  placeholder="Tell us about your supplier collaboration proposal..."
                  rows={3}
                ...
                >
                  ...
                  Submit Supplier Partnership Inquiry
                </button>
              </form>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-white/10 rounded-lg p-3 sm:p-4 border border-white/20">
                  ...
                  <p className="text-gray-300 text-xs sm:text-sm mb-3 sm:mb-4">
                    Submit your supplier-related questions, collaboration inquiries, or general support requests through our dedicated support form.
                  </p>
                  <button
            ...
            <div className="glass-effect rounded-2xl p-4 sm:p-6 lg:p-8 backdrop-blur-xl border border-white/20">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-300">Form for supplier inquiries with message and file upload.</p>
                </div>
              </div>
              ...
              <form onSubmit={handleQuickFormSubmit} className="space-y-4">
                ...
                />
                <textarea
                  placeholder="Your supplier collaboration message..."
                  rows={3}
          ...
          <div className="w-full max-w-4xl h-[90vh] bg-gradient-to-br from-primary-dark via-primary-medium to-primary-950 rounded-2xl border border-white/20 flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold">Supplier Support Form</h3>
            ...
            <div className="flex-1 p-4">
              <iframe
                ...
                title="OphoTech Supplier Support Form"
              >
                Loading supplier support form...
              </iframe>
            </div>
          </div>
        </div>
